...
CREATE TABLE IF NOT EXISTS public.profiles (
  ...
  phone TEXT,
  role TEXT CHECK (role IN ('admin', 'employee', 'manager', 'developer', 'marketing')) NOT NULL DEFAULT 'employee',
...
CREATE TABLE IF NOT EXISTS public.bookings (
  ...
  advance_amount NUMERIC(10,2) DEFAULT 0.00 CHECK (advance_amount >= 0),
  payment_proof TEXT DEFAULT '',
  remarks TEXT DEFAULT '',
  booking_source TEXT DEFAULT 'direct',
  agency_commission NUMERIC(10,2) DEFAULT 0.00,
